...
export default function mapIn(context, node) {
    ...
    var relationTokenIndex = context.sourceTokens.indexOfTokenMatchingPredicate(function (token) { return token.type === SourceType.RELATION; }, lastTokenIndexOfLeft, firstTokenIndexOfRight);
