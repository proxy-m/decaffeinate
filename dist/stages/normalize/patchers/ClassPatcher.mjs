...
var ClassPatcher = /** @class */ (function (_super) {
    ...
    ClassPatcher.prototype.patchAsStatement = function () {
        ...
        try {
            for (var assignmentNames_1 = __values(assignmentNames), assignmentNames_1_1 = assignmentNames_1.next(); !assignmentNames_1_1.done; assignmentNames_1_1 = assignmentNames_1.next()) {
    ...
    ClassPatcher.prototype.getNonMethodPatchers = function () {
        ...
        try {
            for (var _b = __values(this.body.statements), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    ClassPatcher.prototype.generateInitClassMethod = function (nonMethodPatchers, customConstructorInfo, insertPoint) {
        ...
        var assignmentNames = [];
        try {
            for (var nonMethodPatchers_1 = __values(nonMethodPatchers), nonMethodPatchers_1_1 = nonMethodPatchers_1.next(); !nonMethodPatchers_1_1.done; nonMethodPatchers_1_1 = nonMethodPatchers_1.next()) {
    ...
    ClassPatcher.prototype.hasAnyAssignments = function (nonMethodPatchers) {
        var e_6, _a;
        try {
            for (var nonMethodPatchers_2 = __values(nonMethodPatchers), nonMethodPatchers_2_1 = nonMethodPatchers_2.next(); !nonMethodPatchers_2_1.done; nonMethodPatchers_2_1 = nonMethodPatchers_2.next()) {
