...
var ForPatcher = /** @class */ (function (_super) {
    ...
    ForPatcher.prototype.getIIFEAssignments = function () {
        if (this.willPatchAsIIFE()) {
            var iifeAssignments = [];
            if (this.keyAssignee) {
                iifeAssignments.push.apply(iifeAssignments, __spread(getAssigneeBindings(this.keyAssignee.node)));
            }
            if (this.valAssignee) {
                iifeAssignments.push.apply(iifeAssignments, __spread(getAssigneeBindings(this.valAssignee.node)));
            }
