...
var ForInPatcher = /** @class */ (function (_super) {
    ...
    ForInPatcher.prototype.canAssigneesBecomeParams = function () {
        ...
        try {
            for (var assignees_1 = __values(assignees), assignees_1_1 = assignees_1.next(); !assignees_1_1.done; assignees_1_1 = assignees_1.next()) {
    ...
    ForInPatcher.prototype.getLastHeaderPatcher = function () {
        ...
        try {
            for (var _b = __values([this.step, this.filter, this.target]), _c = _b.next(); !_c.done; _c = _b.next()) {
