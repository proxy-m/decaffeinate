...
var SlicePatcher = /** @class */ (function (_super) {
    ...
    SlicePatcher.prototype.getSliceStartCode = function (splice) {
        if (splice === void 0) { splice = false; }
        return splice ? '.splice(' : '.slice(';
    };
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    SlicePatcher.prototype.getSpliceEndCode = function (_splice) {
        if (_splice === void 0) { _splice = false; }
        return ')';
    };
    /**
