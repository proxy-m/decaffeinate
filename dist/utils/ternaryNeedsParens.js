...
var ConditionalPatcher_1 = tslib_1.__importDefault(require("../stages/main/patchers/ConditionalPatcher"));
var DynamicMemberAccessOpPatcher_1 = tslib_1.__importDefault(require("../stages/main/patchers/DynamicMemberAccessOpPatcher"));
var FunctionApplicationPatcher_1 = tslib_1.__importDefault(require("../stages/main/patchers/FunctionApplicationPatcher"));
var InOpPatcher_1 = tslib_1.__importDefault(require("../stages/main/patchers/InOpPatcher"));
var SoakedDynamicMemberAccessOpPatcher_1 = tslib_1.__importDefault(require("../stages/main/patchers/SoakedDynamicMemberAccessOpPatcher"));
var SoakedFunctionApplicationPatcher_1 = tslib_1.__importDefault(require("../stages/main/patchers/SoakedFunctionApplicationPatcher"));
var SoakedMemberAccessOpPatcher_1 = tslib_1.__importDefault(require("../stages/main/patchers/SoakedMemberAccessOpPatcher"));
var WhilePatcher_1 = tslib_1.__importDefault(require("../stages/main/patchers/WhilePatcher"));
/**
