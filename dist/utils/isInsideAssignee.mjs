import { AssignOp, CompoundAssignOp, DynamicMemberAccessOp, FunctionApplication, MemberAccessOp, PostDecrementOp, PostIncrementOp, PreDecrementOp, PreIncrementOp, SoakedDynamicMemberAccessOp, SoakedMemberAccessOp, SoakedNewOp, SoakedFunctionApplication, } from 'decaffeinate-parser/dist/nodes';
/**
 ...
 * ```
 */
export default function isInsideAssignee(node) {
    if (!node.parentNode) {
        return false;
    }
